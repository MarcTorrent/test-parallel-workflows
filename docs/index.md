...
**Framework Overview**  
*Essential concepts and commands for parallel development workflows*
...
7. [Commands Reference - Slash Commands](#7-commands-reference---slash-commands-)
8. [Commands Reference - Scripts](#8-commands-reference---scripts-secondary)
...
## 7. Commands Reference - Slash Commands ⭐
...
## 8. Commands Reference - Scripts (Secondary)
